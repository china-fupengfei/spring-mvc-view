...
public class SecurityFilter implements Filter {
    ...
    // sql关键字
    private static final String[] INJ_STRS = { " ' ", " and ", "exec ", "insert ", "select ", "delete ", "update ", 
                                               " count ", " chr ", " * ", " % ", " mid ", " master ", "truncate ", 
                                               " char ", "declare ", " ; ", " or ", " - ", " + ", " , " };

    // 需要拦截的JS字符关键字
    private static final String[] SAFELESS = { "<script", "</script", "%3cscript", "%3c/script", "set-cookie", "<iframe", "</iframe", 
                                               "<frame", "</frame", "%3ciframe", "%3c/iframe", "%3cframe", "%3c/frame", "<body", "</body", 
                                               "%3cbody", "%3c/body", "javascript:", "src=\"javascript:", "<img", "%3cimg", " style='", 
                                               "%20style='", "alert("/*, "<", ">", "</", "/>", "%3c", "%3e", "%3c/", "/%3e"*/ };
